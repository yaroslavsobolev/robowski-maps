...
if __name__ == '__main__':
    ...
    check_volume_by_pipetter = check_volume_pysimplegui() # The automatic volume check is broken, use the values in the Excel instead. 20240226. Yankai
   ...
   #
    ...
    #
    # for index, event in enumerate(event_list_to_run_sorted):
    #     # if 'nYTfQ' in event.event_label:
    #     #     print(index, event.substance, event.transfer_volume, event.tip_type)
    #     print(event.liquidClassTableIndex)

# a = zm.liquid_class_table_para
# # save the dictionary a to a json file
# with open('liquid_class_table_para.json', 'w') as f:
#     json.dump(a, f)
#
# # load the dictionary from the json file
# with open('liquid_class_table_para_20240227.json', 'r') as f:
#     b = json.load(f)


    # for num, event in enumerate(event_list_to_run_sorted):
    #     # event.destination_container = brb.plate_list[2].containers[num]
    #     print(event.transfer_volume, event.tip_type, event.liquidClassTableIndex)
