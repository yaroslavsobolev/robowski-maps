...
if __name__ == '__main__':
    ...
    # # server settings
    filename = repo_data_path + 'kinetics_models/ugi_v3_outputs/ugi_v2_emcee_backend_gauss_2025_01_14a.h5'
    ...
    fig.savefig(repo_data_path + 'kinetics_models/ugi_v3_outputs/tempcorner.png', dpi=300)
    plt.show()
