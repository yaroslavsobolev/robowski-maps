...
df_results = pd.read_csv(data_folder + experiment_name + f'results/interpolated_product_concentration_together_with_model_2025-02-16.csv')
...
column_to_plot = 'v3_model_yield'

# df_results = pd.read_csv(data_folder + experiment_name + f'results/interpolated_product_concentration.csv')
# replace negative values in yield column with zeros
df_results[column_to_plot] = df_results[column_to_plot].apply(lambda x: 0 if x < 0 else x)
