...
This particular script implements the model in the full version after the change of variables.
'''
...
def print_parameters_with_names(theta):
    parameter_names = ['k1', 'k_1', 'k2', 'K2', 'K3', 'k_3', 'k4', 'k_4', 'k5', 'k6', 'k_6', 'k7', 'k8', 'k9', 'km1', 'k_m1', 'Km3', 'pKa_ptsa', 'pKa_BuNH3', 'pKa_DMFH', 'pKa_p1', 'pKa_p2', 'pKa_p3', 'pKa_c', 'pKa_ch', 'pKa_q1', 'pKa_q2h', 'pKa_m1h', 'pKa_m4h', 'pKa_me2nh2', 'pKa_q4']
...
def residuals_parallel_with_timeout(theta):
    ...
    storage_for_parallel_evaluation_results = [None] * len(indices_here)
    print(f'computing residuals in parallel for theta={theta}')
    # np.save('theta_v3rrr_REV_intermediate_during_opt_with_timeouts.npy', theta)
    assert len(theta) == 31
    list_of_parameter_lists = [[i] + list(theta) for i in indices_here]
    # with Pool(77) as pool:
