...
dft_data = np.loadtxt('misc_scripts/dft_molar-absorptivity-spectra/dft_uv-vis/methoxy-b3lyp-31.txt', skiprows=4, usecols=(0,1))
...
# dft_data = np.loadtxt('misc_scripts/dft_molar-absorptivity-spectra/dft_uv-vis/methoxy-CAMb3lyp-311_t_cq3.txt', skiprows=4, usecols=(0,1))
# # compute absorbance for 1 mm light path and 0.0003 mol/L
# dft_data[:, 1] *= 0.0003 / 10
# plt.plot(dft_data[:, 0], dft_data[:, 1], label='theory, CAM-B3LYP', alpha=0.5)


dft_data = np.loadtxt('misc_scripts/dft_molar-absorptivity-spectra/dft_uv-vis/methoxy_15states_cam-b3lyp__6-311plusg_d-p_.txt', skiprows=4, usecols=(0,1))
# compute absorbance for 1 mm light path and 0.0003 mol/L
dft_data[:, 1] *= 0.0003 / 10
