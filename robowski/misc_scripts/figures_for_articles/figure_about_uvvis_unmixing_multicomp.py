...
def spectrum_to_concentration_local(sp, target_spectrum_input, calibration_folder, calibrant_shortnames,
    ...
    ax.set_ylim(0, 0.4)
    ax.set_xlim(min(wavelengths[mask]), 530)
...
if __name__ == '__main__':
    ...
    run_name = 'multicomp-reactions/2023-06-22-run02'
    concentrations_here = spectrum_to_concentration_local(sp, experiment_folder=data_folder + run_name,
