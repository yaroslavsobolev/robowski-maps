...
cary_file = data_folder + 'Yaroslav/Hantzsch_acetic_influence/EAB_and_acetic_acid.csv'
...
for acetic_acid_volume_added in acetic_acid_volumes:
    cary_column_name = f'EAB_with_{acetic_acid_volume_added}uL_acetic_rep1'
    ...
    plt.plot(wavelengths_of_reference, spec, label=f'{acetic_acid_volume_added/ 60 * 0.005978*1000:.2f} mM acetic acid', color=plt.cm.viridis(list(acetic_acid_volumes).index(acetic_acid_volume_added) / len(acetic_acid_volumes)),
             alpha=0.5)
