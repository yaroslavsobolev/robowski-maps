...
# fig.savefig('misc-scripts/figures/bootstrapped_keq_fits_E1.png', dpi=300)
# plt.show()
...
fig.set_size_inches(14.5, 14.5)
fig.savefig('misc-scripts/figures/bootstrapped_keq_fits_E1_2024-12-11b.png', dpi=300)
plt.show()
...
# fig = corner.corner(samples, labels=labels, show_titles=True, hist_bin_factor=1, range=[0.95]*10, plot_contours=False, figsize=(12.5, 12.5), bins=14, labelpad=0.06, truths=truths)
# fig.set_size_inches(14.5, 14.5)
# fig.savefig('misc-scripts/figures/bootstrapped_keq_fits_E1_temps16-21-26.png', dpi=300)
# plt.show()