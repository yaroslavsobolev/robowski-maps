...
if 'ROBOCHEM_DATA_PATH' in os.environ:
    activity_folder = 'misc-scripts/activity_data/e1_hanna/'
else:
...
if __name__ == '__main__':
    ...
    # keq_initials = np.load('keq_fits_with_errs_tdep_homosc_2024-12-14a_temps16-21-26.npy')
    ...
    #     np.save(f'bootstrapped_keq_fits_size{i+1}_2024-12-14_temps16-21-26.npy', np.array(bootstrapped_keq_fits))
    ...
    if 'ROBOCHEM_DATA_PATH' in os.environ:
        np.save(f'{data_folder}simple-reactions/2023-09-14-run01/results/kinetics/keq_fits_with_errs_tdep_homosc_2024-12-14a_temps16-21-26.npy', np.array((keq_fit, keq_err)))
    else:
        np.save('keq_fits_with_errs_tdep_homosc_2024-12-14a_temps16-21-26.npy', np.array((keq_fit, keq_err)))
