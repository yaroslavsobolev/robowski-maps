...
# figure_filename = f'misc-scripts/figures/cubes/Ugi-smoothed_{column_to_plot}_ptsa{ith_ptsa}_ptsaval{ptsa_target:.3f}_{what_to_plot}.png'

figure_filename = f'misc-scripts/figures/cubes/Ugi-raw_{column_to_plot}_ptsa{ith_ptsa}_ptsaval{ptsa_target:.3f}_{what_to_plot}.png'
